...
def make_testback_data(n, nr, diff=(0x0040,0)):
  nr = nr
  ...
  ctdata0l, ctdata0r = dec_one_round((ctdata0l, ctdata0r), ks_back[0]);
  ctdata1l, ctdata1r = dec_one_round((ctdata1l, ctdata1r), ks_back[0]);
