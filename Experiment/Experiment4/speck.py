...
def convert_to_binary(arr):
  X = np.zeros((12 * WORD_SIZE(),len(arr[0])),dtype=np.uint8);
  for i in range(12 * WORD_SIZE()):
    index = i // WORD_SIZE();
...
def make_train_data(n, nr, diff=(0x0040,0)):
  ...
  ks_back = np.frombuffer(urandom(8*n), dtype=np.uint16).reshape(4, -1);
  ks_back = expand_key(ks_back, 2);
  ...
  ctdata0l_2, ctdata0r_2 = dec_one_round((ctdata0l, ctdata0r), ks_back[0]);
  ctdata1l_2, ctdata1r_2 = dec_one_round((ctdata1l, ctdata1r), ks_back[0]);
  ctdata0l_3, ctdata0r_3 = dec_one_round((ctdata0l, ctdata0r), ks_back[1]);
  ctdata1l_3, ctdata1r_3 = dec_one_round((ctdata1l, ctdata1r), ks_back[1]);
  X = convert_to_binary([ctdata0l, ctdata0r, ctdata1l, ctdata1r,ctdata0l_2, ctdata0r_2,ctdata1l_2, ctdata1r_2,ctdata0l_3, ctdata0r_3,ctdata1l_3, ctdata1r_3]);
  return(X,Y);
